...
MODEL_PRICING: Dict[str, Dict[str, float]] = {
    ...
    "gemini-3.7-flash": {"input": 0.10 / 1e6, "output": 0.40 / 1e6},
    "gemini-3.7-flash-thinking-exp-01-21": {"input": 0.10 / 1e6, "output": 0.40 / 1e6},
    "gemini-2.0-pro-exp-02-05": {"input": 1.25 / 1e6, "output": 5.00 / 1e6},
    "gemini-3.7-flash-lite": {"input": 0.075 / 1e6, "output": 0.30 / 1e6},
...
CAPABILITY_MATRIX: Dict[str, Dict[str, Any]] = {
    ...
    "gemini-3.1-pro-preview": {"context_window": 2_000_000, "languages": ["*"], "strength": "deep_reasoning"},
    "gemini-2.5-flash": {"context_window": 2_000_000, "languages": ["*"], "strength": "fast_multimodal"},
    "gemini-3.7-flash": {"context_window": 1_000_000, "languages": ["*"], "strength": "fast"},
    "gemini-3.7-flash-thinking-exp-01-21": {"context_window": 1_000_000, "languages": ["*"], "strength": "thinking"},
    "gemini-2.0-pro-exp-02-05": {"context_window": 2_000_000, "languages": ["*"], "strength": "frontier_reasoning"},
    "gemini-3.7-flash-lite": {"context_window": 1_000_000, "languages": ["*"], "strength": "cheap"},
