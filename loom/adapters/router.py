...
CAPABILITY_MATRIX: Dict[str, Dict[str, Any]] = {
    ...
    "gemini-3-pro-preview": {"context_window": 2_000_000, "languages": ["*"], "strength": "deep_reasoning"},
    "gemini-3.7-flash": {"context_window": 2_000_000, "languages": ["*"], "strength": "hybrid_thinking"},
    "gemini-3.5-flash": {"context_window": 2_000_000, "languages": ["*"], "strength": "fast_multimodal"},
    "gemini-3.1-flash-lite": {"context_window": 1_000_000, "languages": ["*"], "strength": "lightweight_speed"},
    "gemini-2.5-pro": {"context_window": 2_000_000, "languages": ["*"], "strength": "ultra_reasoning"},
    "gemini-2.5-flash": {"context_window": 1_000_000, "languages": ["*"], "strength": "fast_multimodal"},
    "gemini-2.0-flash": {"context_window": 1_000_000, "languages": ["*"], "strength": "realtime_speed"},
    "gemini-2.0-flash-lite": {"context_window": 1_000_000, "languages": ["*"], "strength": "ultra_fast"},
